...
!define URL http://www.tajcoin.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/tajcoin.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\tajcoin-qt.exe
...
OutFile tajcoin-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/tajcoin-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/tajcoind.exe
    ...
    #Delete /REBOOTOK $INSTDIR\tajcoin.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\tajcoin-qt.exe
